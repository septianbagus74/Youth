...
public class NegativeExpressionActivity extends BaseToolbarActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_negative_expression);
    ...
    public void onClick(View v) {
        if (v.getId() == R.id.btnContohSoal) {
            Intent intentMean = new Intent(NegativeExpressionActivity.this, MenuActivity.class);
